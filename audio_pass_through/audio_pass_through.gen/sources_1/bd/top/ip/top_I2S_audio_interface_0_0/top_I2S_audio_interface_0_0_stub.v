...
//               d:/ENSC462/github/GitHub/audio_pass_through/audio_pass_through.gen/sources_1/bd/top/ip/top_I2S_audio_interface_0_0/top_I2S_audio_interface_0_0_stub.v
...
module top_I2S_audio_interface_0_0(rst, fpga_clk, bclk, lrclk, sdata_in, 
  ...
  read_states, write_states, sdata_out)
/* synthesis syn_black_box black_box_pad_pin="rst,fpga_clk,bclk,lrclk,sdata_in,audio_valid_adau,audio_r_adau[23:0],audio_l_adau[23:0],audio_valid_pl,audio_r_pl[23:0],audio_l_pl[23:0],read_states[2:0],write_states[2:0],sdata_out" */;
  input rst;
  input fpga_clk;
  input bclk;
  input lrclk;
